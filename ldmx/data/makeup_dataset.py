...
class MakeupDataset(Dataset):
    def __init__(self, is_train, image_path, seg_path,depth_path):
        ...
        self.appearance_aug = albumentations.Compose([
            albumentations.ColorJitter(brightness=0.2, contrast=0.2, saturation=0.2, hue=0.2, p=0.5)
        ])

        self.appearance_aug2 = albumentations.Compose([
            albumentations.ColorJitter(brightness=0.2, contrast=0.2, saturation=0.2, hue=0.2, p=1.0)
        ])

        self.spatial_aug_without_elas = albumentations.Compose([
            albumentations.Resize(height=286, width=286),
        ...
        self.spatial_aug_with_elas = albumentations.Compose([
            albumentations.Resize(height=286, width=286),
            albumentations.RandomCrop(height=256, width=256),
