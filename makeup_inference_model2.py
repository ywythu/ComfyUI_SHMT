...
from .ldmx.models.diffusion.ddim_test_model2 import DDIMSampler
from .ldmx.models.diffusion.plms import PLMSSampler
from .ldmx.data.makeup_dataset import MakeupDatasetTest
import torch.nn.functional as F
from .ldmx.modules.diffusionmodules.openaimodel import Lap_Pyramid_Conv
...
def infer_main_v2(model, model2,seed, width,height,latent_channels,
                     downsampling_factor,ddim_steps,ddim_eta,batch_size,scale,precision,
                  skip_save,plms,fixed_code,device,outpath,ref_image_path,ref_seg_path,source_seg_path,source_depth_path,source_image_path,proportionOFmodel1):

    seed_everything(seed)
    model.model2=model2
    model.proportionOFmodel1=proportionOFmodel1
