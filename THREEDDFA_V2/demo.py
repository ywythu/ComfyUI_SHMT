...
def main(args):
    ...
    cfg["bfm_fp"]=args.bfm_fp
    cfg["checkpoint_fp"]=args.checkpoint_fp
    ...
    wfp = f'{args.folder}/{args.folder_prefix}_{args.opt}' + new_suffix
    ...
    if args.opt == '2d_sparse':
        ...
        render(img, ver_lst, tddfa.tri, alpha=1.0, show_flag=args.show_flag, wfp=wfp,with_bg_flag=args.with_bg_flag)
    elif args.opt == 'depth':
